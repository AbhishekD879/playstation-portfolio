...
export const FREE_GAMES: FreeGame[] = [
  ...
  // Open-source homebrew found by a GitHub sweep (OSI licences, release builds; relayed). Swept on the preview
  // before listing — the two libdragon N64 jam ROMs crashed the core (table index out of bounds) and the PS1
  // homebrew disc stayed black on the HLE BIOS, so they are not here.
