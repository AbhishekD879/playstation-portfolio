...
export const GAME_TOP: GameTopEntry[] = [
  ...
  { kind: "item", id: "mobile" },
  { kind: "folder", id: "pc", title: "PC Games", icon: "monitor", blurb: "DOOM · Counter-Strike · point & click · Micropolis · Jazz · Wolf3D · Quake · OpenTTD", items: ["doom", "doomrtx", "cs", "scummvm", "micropolis", "jazz", "wolf", "quake", "openttd"] },
