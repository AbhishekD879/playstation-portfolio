...
export const GAME_TOP: GameTopEntry[] = [
  ...
  { kind: "item", id: "mobile" },
  { kind: "folder", id: "pc", title: "PC Games", icon: "monitor", blurb: "DOOM · Counter-Strike · point & click · Wolf3D · Quake · Duke 3D · Descent · Diablo · OpenHV · HexGL", items: ["doom", "doomrtx", "cs", "scummvm", "micropolis", "jazz", "wolf", "quake", "openttd", "diablo", "jazz2", "descent", "duke", "gorescript", "hexgl", "openhv", "hl2", "pepsiman"] },
