...
export const GAME_TOP: GameTopEntry[] = [
  ...
  { kind: "item", id: "mobile" },
  { kind: "folder", id: "pc", title: "PC Games", icon: "monitor", blurb: "DOOM · Counter-Strike · point & click · Quake · Duke 3D · Diablo · Cataclysm · Endless Sky · OpenHV · HexGL", items: ["doom", "doomrtx", "cs", "scummvm", "micropolis", "jazz", "wolf", "quake", "openttd", "diablo", "jazz2", "descent", "duke", "gorescript", "hexgl", "openhv", "opentyrian", "cdda", "endlesssky", "openrct2", "luanti", "hl2", "pepsiman"] },
