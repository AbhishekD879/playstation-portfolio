...
const DEFAULT_OFF = new Set(["crt", "galaxyboot", "privacy", "cobrowse", "syscity", "renpyconvert", "engineerrors"]); // opt-in: full-console CRT, GPU galaxy boot, hidden Privacy Toolkit, Watch Party shared browser (costs $ + needs API key), System City learning hub (in development)
...
const APPS: { id: string; title: string; cat: string }[] = [
  ...
  { id: "gesture", title: "Camera Navigation (beta)", cat: "Extras" },
  { id: "padtest", title: "Controller Test", cat: "Extras" },
  { id: "browser", title: "Browser", cat: "Web" },
  { id: "wiki", title: "Wikipedia", cat: "Web" },
  { id: "dict", title: "Dictionary", cat: "Web" },
  { id: "library", title: "Open Library (books)", cat: "Web" },
  { id: "hn", title: "Hacker News", cat: "Web" },
  { id: "devto", title: "DEV Community", cat: "Web" },
